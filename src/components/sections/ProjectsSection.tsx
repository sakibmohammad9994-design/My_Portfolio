      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {PROJECTS_DATA.map((project, index) => (
          <motion.div
            ...
            className="h-full"
          >
            <SpotlightCard className="glass-card group flex flex-col h-full">
              {/* Project Image Placeholder */}
              <div className="w-full h-48 bg-[#0a0a0a] border-b border-white/5 relative overflow-hidden">
              ...
              <div className="p-8 flex flex-col flex-grow relative z-10">
                <div className="flex justify-between items-start mb-4">
                  <h3 className="text-xl font-semibold text-white group-hover:text-[#ff5e00] transition-colors">
                    {project.title}
                  </h3>
